...
export default class CoinbaseKeyring extends EventEmitter implements Keyring<KeyringOptions> {
    ...
    getSessionStatus(address: string): "DISCONNECTED" | "CONNECTED" | "ACCOUNT_ERROR" | "REJECTED" | "ADDRESS_DUPLICATE" | "ACCOUNT_CHANGED" | undefined;
    getSessionAccount(address: string): {
        chainId: number | undefined;
        account: `0x${string}` | undefined;
        status: "DISCONNECTED" | "CONNECTED" | "ACCOUNT_ERROR" | "REJECTED" | "ADDRESS_DUPLICATE" | "ACCOUNT_CHANGED" | undefined;
    };
